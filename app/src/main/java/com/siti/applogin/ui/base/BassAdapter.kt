package com.siti.applogin.ui.base
...
import com.siti.applogin.BR

abstract class BassAdapter<T>(@field:LayoutRes private var layoutId: Int) :
    RecyclerView.Adapter<BassAdapter<T>.ViewHolder>(), BindableAdapter<List<T>> {
